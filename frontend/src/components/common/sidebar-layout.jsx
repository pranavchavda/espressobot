...
export function SidebarLayout({ navbar, sidebar, children }) {
  ...
  return (
    <div className="relative isolate flex min-h-screen h-screen w-full bg-white max-lg:flex-col lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950 overflow-hidden">
      {/* Sidebar on desktop */}
      <div className="fixed inset-y-0 left-0 w-64 max-lg:hidden h-full overflow-y-auto">{sidebar}</div>
      ...
      <div className="flex flex-1 flex-col lg:pl-64"> {/* Added lg:pl-64 to account for desktop sidebar */}
        ...
        {/* Main Content */}
        <main className="flex flex-1 flex-col pb-2 lg:min-w-0 lg:pt-2 lg:pr-2"> {/* Removed lg:pl-64 from here */}
          <div className="grow flex flex-col p-6 lg:rounded-lg lg:bg-white lg:p-10 lg:shadow-xs lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10">
