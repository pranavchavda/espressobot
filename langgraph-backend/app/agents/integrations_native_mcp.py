...
class IntegrationsAgentNativeMCP(ContextAwareMixin):
...
Always provide clear, formatted responses with integration status and confirm successful operations."""
    ...
    async def __call__(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Run the agent
            logger.info(f"🚀 Running Integrations agent with context-aware prompt with message: {last_message.content[:100]}...")
